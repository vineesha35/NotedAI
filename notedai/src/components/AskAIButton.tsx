...
const handleInput = () => {
  ...
  const result = await askAIAboutNotesAction(newQuestions, responses);
  ...
  return <Dialog open={open} onOpenChange={handleOnOpenChange}>
      <form>
        ...
        <DialogContent className="custom-scrolbar flex h-[85vh] max-4-xl flex-col overflow-y-auto" ref={contentRef}>
          <DialogHeader>
